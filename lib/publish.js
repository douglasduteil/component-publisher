...
var DIR = cm.component_publisher_dir + '/clones';
...
module.exports = function (opt, done) {
  ...
  var options = {
    cloneLocation: path.resolve(path.join(process.cwd(), DIR, this.env.branch)),
    dirSrc: path.resolve(path.join(cm.component_publisher_dir, this.env.branch)),
